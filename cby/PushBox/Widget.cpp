...
//    QString fileName=QFileDialog::getOpenFileName(this,"打开地图","./","*.txt");
    QString filename="D:\\qt\\PushBox\\Map\\lv1.txt";
...
//    bgPainter.end();
    ...
    QImage img2(byggurl);
    mMapPainter->drawImage(QRect(960,180,353,560),img2);
     show_exit();
    //画地图
    mPMap->Paint(mMapPainter,QPoint(60,60));//传位置

    //画人物
    mRole->Paint(mMapPainter,QPoint(60,60));//可以自己做偏移
