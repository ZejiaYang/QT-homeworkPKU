...
void MiniMazeGameWidgetIII::show_introWords(){
    ui->IntroLabel->setGeometry(WORDS_POS_X,WORDS_POS_Y,800,1200);
    ui->IntroLabel->setText("            理科一号楼，\n"
                            ...
                            "这将会是你学到的第一个技能。\n\n"
                            "      按 任意键 开始游戏。\n");
    ui->IntroLabel->setFont(QFont("华文新魏", 27));
    ...
    words_animation->setStartValue(QRect(1280,WORDS_POS_Y,800,650));
    words_animation->setEndValue(QRect(WORDS_POS_X,WORDS_POS_Y,800,650));
