...
//    runner_timer.setInterval(RUNNER_STEP_TIME);
//    runner_timer.start();

//    runnerLabel = new QLabel();
//    runnerLabel->setGeometry(RUNNER_START_POS_X,RUNNER_START_POS_Y,130,130);
//    runnerMovie = new QMovie(":/parkour_resource/runner2.gif");
//    runnerLabel->setMovie(runnerMovie);
//    runnerMovie->start();
//    runnerLabel->show();
