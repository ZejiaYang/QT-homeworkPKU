...
//            this,SLOT(onBtnClicked()));
    ...
    startBtn->setGeometry(totalRadius+100,350,120,40);//设置加载位置

    endBtn  = new QPushButton(this);
    endBtn->setText(tr("结束游戏"));
    endBtn->setFont(QFont(tr("宋体"),12));
    endBtn->setGeometry(totalRadius+220,350,120,40);//设置加载位置
    //20-400
...
//            this,SLOT(onSpinBoxValueChanged(int)));
    ...
    curStepCount->setGeometry(totalRadius+160,410,120,40);//510-380=130
    ...
    curStepCountText->setGeometry(totalRadius+50,425,100,30);//525-380=145
...
//    diffLevelText->setFont(QFont(tr("宋体"),12));
    ...
    timeText->setGeometry(totalRadius+50,480,100,30);//580-380=200
    ...
    timeLineEdit->setGeometry(totalRadius+160,470,120,40);//570-380=190
...
//void Widget::onBtnClicked()//选择图片的逻辑
//{
