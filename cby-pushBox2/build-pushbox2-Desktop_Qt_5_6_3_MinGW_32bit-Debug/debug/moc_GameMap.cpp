...
#include "C:/Users/Dell/Desktop/cby-pushBox2/pushbox2/GameMap.h"
...
const QMetaObject GameMap::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GameMap.data,
      qt_meta_data_GameMap,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GameMap::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GameMap.stringdata0))
        return static_cast<void*>(const_cast< GameMap*>(this));
